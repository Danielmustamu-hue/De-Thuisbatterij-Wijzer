...
const Calculator: React.FC<CalculatorProps> = ({ onResult }) => {
  ...
  return (
    <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] border border-gray-100 max-w-xl w-full relative overflow-hidden">
      ...
      <h3 className="text-2xl font-black mb-8 text-gray-900 tracking-tight italic">Start Systeemanalyse ⚡️</h3>
        ...
        >
          {loading ? (
             <div className="flex items-center space-x-3">
               ...
               <span className="text-sm uppercase tracking-widest">Consultancy Mode...</span>
             </div>
          ) : (
            <>
                <span>Toon Mijn Rapport</span>
                <svg className="w-5 h-5 text-[#48BB78]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
            </>
          )}
        </button>
      </form>
